...
public class DetalheAreaView {
    ...
    private final List<TrilhaEstudoView> trilhaEstudo;
    ...
    public DetalheAreaView(
            ...
            List<ProfissaoAreaView> profissoes,
            List<FormacaoLocalView> formacoes,
            List<TrilhaEstudoView> trilhaEstudo,
            List<String> ferramentas
    ) {
        ...
        this.trilhaEstudo = List.copyOf(trilhaEstudo);
    ...
    public List<TrilhaEstudoView> getTrilhaEstudo() {
        return trilhaEstudo;
    }
